<?php 
  ...
  if (isset($_REQUEST["add"])) 
  {
    ...
    $sdt = $_REQUEST["sdt"];	
    $content =  new Danhsach($ten, $email, $sdt);
    Danhsach::add($content);
  }
  /**
 * Edit
 */
              ...
              <table class="table" >
                ...
                <?php
                  ...
                  <tr class="sidebar-link">
                    ...
                    <td class="d-flex">
						<button class="btn mr-3" title="Chỉnh sửa liên hệ" data-toggle="modal" data-target="#editItem<?php echo $i ?>"><i class="far fa-edit"></i></button>
						<button class="btn" title="Xóa" name="delete" data-toggle="modal" data-target="#deleteItem<?php echo $i ?>"><i class="fas fa-trash-alt"></i></button>
            <!--Edit-->
										...
										<div class="modal-body">
											<form>
												<div class="form-group ">
													...
													<input type="text" name="ten" class="form-control" value="<?php echo $lsDs[$i]->ten ?>" placeholder="Tên">
                        </div>
                        <div class="form-group">
													<label for="class">Email</label>
													<input type="email" name="email" class="form-control" value="<?php echo $lsDs[$i]->email ?>" placeholder="Email">
												</div>
												
												<div class="form-group">
													<label for="to">Số điện thoại</label>
													<input type="text" name="sdt" class="form-control" value="<?php echo $lsDs[$i]->sdt ?>" placeholder="Số điện thoại">
												</div>
											
												<div class="modal-footer">
												<button class="btn btn-secondary" type="button" data-dismiss="modal">Hủy</button>
													<button class="btn btn-primary" name="edit" type="submit" value="<?php echo $lsDs[$i]->ten ?>">Lưu</button>
												</div>
											</form>
										</div>
									</div>
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										<div class="modal-header">
											...
											<button class="close" type="button" data-dismiss="modal" aria-label="Hủy">
												<span aria-hidden="true">×</span>
											</button>
										</div>
										<div class="modal-body">Xóa người liên hệ này</div>
										<div class="modal-footer">
											<button class="btn btn-danger" name="delete" type="submit" value="<?php echo $lsDs[$i]->ten ?>">Xóa</button>
											<button class="btn btn-secondary" type="button" data-dismiss="modal">Hủy</button>
										</div>
									</div>
								</div>
